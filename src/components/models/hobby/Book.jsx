...
const Book = ({isRotating, setIsRotating, ...props}) => {
    ...
    const handleKeyDown = (e) => {
        if(e.key === 'ArrowLeft'){
            ...
            bookRef.current.rotation.y -= 0.01 * Math.PI;
    ...
    return (
        <a.group ref={bookRef} {...props} dispose={null}>
            <mesh castShadow receiveShadow geometry={nodes.Kniha.geometry} material={materials.LogoBg} />
            <mesh
                castShadow
                receiveShadow
            ...
            />
            <mesh castShadow receiveShadow geometry={nodes.Page.geometry} material={materials.LogoBg} />
            <mesh
                castShadow
                receiveShadow
