...
function Hero(){
    return(
        <div className='hero'>
            <div className='p-20'>
                <div className='flex justify-evenly content-evenly bg-orange-500'>
                    <div className='flex-col w-2/4 h-2/4 pt-20 z-50 content-evenly space-y-3 space-x-1 relative'>
                    ...
                    <div className='w-2/4 h-1/4 z-10 w-screen' >
                        <HeroMesh/>
                    </div>
                </div>
            </div>
