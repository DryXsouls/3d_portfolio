...
const HobbyMesh = () => {
    ...
    const [likeMesh1Scale, likeMesh1Position, likeMesh1Rotation] = [[0.1,0.1,0.1],[-2.55,-0.45,-0.25],[0.25,0.25,0]];
    const [likeMesh2Scale, likeMesh2Position, likeMesh2Rotation] = [[0.075,0.075,0.075],[-2.15,-0.45,0],[0.25,0.25,0]];
    const [likeMesh3Scale, likeMesh3Position, likeMesh3Rotation] = [[0.075,0.075,0.075],[-2.15,-0.45,0],[0.25,0.25,0]];
    const [likeMesh4Scale, likeMesh4Position, likeMesh4Rotation] = [[0.075,0.075,0.075],[-2.15,-0.45,0],[0.25,0.25,0]];
    const [likeMesh5Scale, likeMesh5Position, likeMesh5Rotation] = [[0.075,0.075,0.075],[-2.15,-0.45,0],[0.25,0.25,0]];


    const [hobbyMesh1Scale, hobbyMesh1Position, hobbyMesh1Rotation] = [[0.1,0.1,0.1],[0.5,-0.75,-0.25],[0.25,-0.25,0]];
    const [hobbyMesh2Scale, hobbyMesh2Position, hobbyMesh2Rotation] = [[0.1,0.1,0.1],[1.25,-0.75,-0.25],[0.25,-0.25,0]];
